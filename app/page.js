...
export default async function Home() {
  return (
    <main className="min-h-screen bg-orange-100 flex justify-center items-center">
      <img src="/images/car.png" alt="car" className="h-36 conveyor top-[20%]" style={{ animationDelay: "1s" }}/>
      <img src="/images/office-chair.png" alt="office chair" className="h-36 conveyor top-[20%]"/>
